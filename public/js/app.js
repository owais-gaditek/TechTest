...
/* harmony import */ var _article__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./article */ "./resources/js/article.js");
/* harmony import */ var _article__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_article__WEBPACK_IMPORTED_MODULE_1__);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var renderArticles = function renderArticles(articles) {
    articleList.innerHTML = articles.map(function (article) {
      return "\n            <li class=\"article-item mb-4\">\n                <h2>".concat(article.title, "</h2>\n                <p>").concat(article.content, "</p>\n                ").concat(article.image_url ? "<img src=\"".concat(article.image_url, "\" alt=\"").concat(article.title, "\" class=\"img-fluid mb-2\">") : '', "\n                <button class=\"btn btn-secondary me-2\" onclick=\"editArticle(").concat(article.id, ")\">Edit</button>\n                <button class=\"btn btn-danger\" onclick=\"deleteArticle(").concat(article.id, ")\">Delete</button>\n            </li>\n        ");
    }).join('');
  };

  // Handle form submission for create/update
  articleForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
      var id, method, url, formData, data, response;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            method = id ? 'PUT' : 'POST';
            url = id ? "/api/articles/".concat(id) : '/api/articles';
          ...
          case 18:
            ...
            _context2.t0.error.call(_context2.t0, 'Error saving article:', _context2.t1);
          case 20:
            _context2.next = 25;
            break;
          case 22:
            ...
            console.error('Error submitting form:', _context2.t2);
          case 25:
          case "end":
  ...
  document.getElementById('create-article-button').addEventListener('click', function () {
    articleForm.reset();
  ...
  // Edit an article
  window.editArticle = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 16:
            ...
            console.error('Error fetching article:', _context3.t0);
          case 19:
          case "end":
  ...
  // Delete an article
  window.deleteArticle = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 11:
            ...
            _context4.t0.error.call(_context4.t0, 'Error deleting article:', _context4.t1);
          case 13:
            _context4.next = 18;
            break;
          case 15:
            ...
            console.error('Error deleting article:', _context4.t2);
          case 18:
          case "end":
